...
public class EaseShowBigImageActivity extends EaseBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show = (RelativeLayout) findViewById(R.id.show_big);
        show.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(EaseShowBigImageActivity.this, "123", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void show(  ){
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(EaseShowBigImageActivity.this, "1234", Toast.LENGTH_SHORT).show();
            }
        });
        finish();
    }
